...
5. When running the scripts in the Area/Accuracy Estimation Toolbox, a Dialog Pane will appear (E). The Dialog Pane is where you specify the information required for each step of the sampling design, response design, and analysis.  
6. The Console (C) displays output specified by script. If errors occur while running a scipt, the error messages are displayed here.
